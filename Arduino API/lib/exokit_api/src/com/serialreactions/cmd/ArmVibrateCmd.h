#ifndef CHI25_EXOSKELETON_API_ARMVIBRATECMD_H
#define CHI25_EXOSKELETON_API_ARMVIBRATECMD_H


#include "com/ICmd.h"

class ArmVibrateCmd: public ICmd {
public:
    /**
...
#endif //CHI25_EXOSKELETON_API_ARMVIBRATECMD_H
