#ifndef CHI25_EXOSKELETON_API_JOINTVIBRATIONCMD_H
#define CHI25_EXOSKELETON_API_JOINTVIBRATIONCMD_H


#include "com/ICmd.h"

class JointVibrationCmd: public ICmd {
public:
...
#endif //CHI25_EXOSKELETON_API_JOINTVIBRATIONCMD_H
