#ifndef CHI25_EXOSKELETON_API_JOINTFILTERSPEEDCMD_H
#define CHI25_EXOSKELETON_API_JOINTFILTERSPEEDCMD_H


#include "com/ICmd.h"

class JointFilterSpeedCmd: public ICmd {
public:
...
#endif //CHI25_EXOSKELETON_API_JOINTFILTERSPEEDCMD_H
