#ifndef CHI25_EXOSKELETON_API_ARMGUIDETOWARDSCMD_H
#define CHI25_EXOSKELETON_API_ARMGUIDETOWARDSCMD_H


#include "com/ICmd.h"

class ArmGuideTowardsCmd: public ICmd {
public:
    /**
...
#endif //CHI25_EXOSKELETON_API_ARMGUIDETOWARDSCMD_H
