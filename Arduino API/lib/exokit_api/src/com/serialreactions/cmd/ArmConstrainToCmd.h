#ifndef CHI25_EXOSKELETON_API_ARMCONSTRAINTOCMD_H
#define CHI25_EXOSKELETON_API_ARMCONSTRAINTOCMD_H


#include "com/ICmd.h"

class ArmConstrainToCmd: public ICmd {
public:
    /**
...
#endif //CHI25_EXOSKELETON_API_ARMCONSTRAINTOCMD_H
