#ifndef CHI25_EXOSKELETON_API_JOINTRESISTCMD_H
#define CHI25_EXOSKELETON_API_JOINTRESISTCMD_H


#include "com/ICmd.h"

class JointResistCmd: public ICmd {
public:
...
#endif //CHI25_EXOSKELETON_API_JOINTRESISTCMD_H
