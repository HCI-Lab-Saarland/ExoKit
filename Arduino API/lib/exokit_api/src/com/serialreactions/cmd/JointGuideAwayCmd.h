#ifndef CHI25_EXOSKELETON_API_JOINTGUIDEAWAYCMD_H
#define CHI25_EXOSKELETON_API_JOINTGUIDEAWAYCMD_H


#include "com/ICmd.h"

class JointGuideAwayCmd: public ICmd {
public:
    /**
...
#endif //CHI25_EXOSKELETON_API_JOINTGUIDEAWAYCMD_H
