#ifndef CHI25_EXOSKELETON_API_ARMGESTURECMD_H
#define CHI25_EXOSKELETON_API_ARMGESTURECMD_H


#include "com/ICmd.h"

class ArmGestureCmd: public ICmd {
public:
    /**
...
#endif //CHI25_EXOSKELETON_API_ARMGESTURECMD_H
