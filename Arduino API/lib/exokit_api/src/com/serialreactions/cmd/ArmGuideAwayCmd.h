#ifndef CHI25_EXOSKELETON_API_ARMGUIDEAWAYCMD_H
#define CHI25_EXOSKELETON_API_ARMGUIDEAWAYCMD_H


#include "com/ICmd.h"

class ArmGuideAwayCmd: public ICmd {
public:
    /**
...
#endif //CHI25_EXOSKELETON_API_ARMGUIDEAWAYCMD_H
