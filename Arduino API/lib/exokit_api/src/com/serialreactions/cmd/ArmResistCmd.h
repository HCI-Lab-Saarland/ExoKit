#ifndef CHI25_EXOSKELETON_API_ARMRESISTCMD_H
#define CHI25_EXOSKELETON_API_ARMRESISTCMD_H


#include "com/ICmd.h"

class ArmResistCmd: public ICmd {
public:
    /**
...
#endif //CHI25_EXOSKELETON_API_ARMRESISTCMD_H
