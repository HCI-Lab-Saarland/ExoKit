#ifndef CHI25_EXOSKELETON_API_JOINTJERKCMD_H
#define CHI25_EXOSKELETON_API_JOINTJERKCMD_H


#include "com/ICmd.h"

class JointJerkCmd: public ICmd {
public:
...
#endif //CHI25_EXOSKELETON_API_JOINTJERKCMD_H
