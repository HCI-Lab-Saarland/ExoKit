#ifndef CHI25_EXOSKELETON_API_JOINTCONSTRAINTOCMD_H
#define CHI25_EXOSKELETON_API_JOINTCONSTRAINTOCMD_H


#include "com/ICmd.h"

class JointConstrainToCmd: public ICmd {
public:
    /**
...
#endif //CHI25_EXOSKELETON_API_JOINTCONSTRAINTOCMD_H
