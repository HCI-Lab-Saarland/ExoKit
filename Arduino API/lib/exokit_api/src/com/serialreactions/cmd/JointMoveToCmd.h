#ifndef CHI25_EXOSKELETON_API_JOINTMOVETOCMD_H
#define CHI25_EXOSKELETON_API_JOINTMOVETOCMD_H


#include "com/ICmd.h"

class JointMoveToCmd: public ICmd {
public:
...
#endif //CHI25_EXOSKELETON_API_JOINTMOVETOCMD_H
