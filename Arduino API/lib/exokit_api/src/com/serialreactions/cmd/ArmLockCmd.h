#ifndef CHI25_EXOSKELETON_API_ARMLOCKCMD_H
#define CHI25_EXOSKELETON_API_ARMLOCKCMD_H


#include "com/ICmd.h"

class ArmLockCmd: public ICmd {
public:
    /**
...
#endif //CHI25_EXOSKELETON_API_ARMLOCKCMD_H
