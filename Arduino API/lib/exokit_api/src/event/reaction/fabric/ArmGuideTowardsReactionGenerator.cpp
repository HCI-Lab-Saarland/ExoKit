#include "ArmGuideTowardsReactionGenerator.h"

void ArmGuideTowardsReactionGenerator::configure(ExoArmAngles pos, float radius, float amplifyPercentage, float resistPercentage) {
...
ComposedReaction &ArmGuideTowardsReactionGenerator::initType(GuideTowardsReactionGenerator &type) {
    return type.init();
}
