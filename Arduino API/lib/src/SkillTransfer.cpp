...
ActionBuilder ab;
Exoskeleton* exoskeleton; // TODO: in accordance to some of Jürgen's prior feedback, we must rename the simpleExo
const float DXL_PROTOCOL_VERSION = 2.0;


void mirrorElbow2ShoulderSide(ActionBuilder& ab) {
    // todo: why is velocity still in here? Shouldn't that be the scale factor?
